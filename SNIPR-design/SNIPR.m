...
library_num = 10; % the number of the design libraries generated.
IS_PARALLEL = 1; % Set IS_PARALLEL = 1 if you want to run on your local computer using multiple cores; otherwise, set to 0
select_num = 3; % the number of top designs generated by the software from the libraries generated
