...
for c = 1:length(dir_list)
    ...
    for c2 = 1:length(strand_names)
        if strcmp(strand_names{c2},'hairpin') || strcmp(strand_names{c2},'rep_hairpin') || strcmp(strand_names{c2},'switch')||strcmp(strand_names{c2},'hairpin0')||strcmp(strand_names{c2},'hairpin_seq')
